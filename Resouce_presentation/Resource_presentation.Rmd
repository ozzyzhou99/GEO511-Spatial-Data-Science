...
is a statistician affiliated with the University of Auckland, New Zealand (now retired, but "honorary researcher"). His research includes statistical computing, survival analysis, and applied statistics.
...
In this talk, I will briefly introduce the main features of the `spatstat` package, including:
...
For a detailed code demonstration with examples, please visit the [interactive resource presentation here](https://ozzyzhou99.github.io/GEO511-Spatial-Data-Science/Resouce_presentation/spatstat_intro.html).
